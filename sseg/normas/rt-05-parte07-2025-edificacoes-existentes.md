...
1. **Menos linhas de medida, com exceções por divisão.** O número de linhas varia por tabela (de 8 a 13 nas transcritas em `scripts/dados/tabelas/tab-rt05-*.json`). As 6I e 6J trazem 12: Acesso de Viatura na Edificação, Compartimentação Horizontal (áreas), Saídas de Emergência, Plano de Emergência, Brigada de Incêndio, Iluminação de Emergência, Detecção de Incêndio, Alarme de Incêndio, Sinalização de Emergência, Extintores, Hidrantes e Mangotinhos, Chuveiros Automáticos. **A falta de Segurança Estrutural, CMAR, Compartimentação Vertical e Controle de Fumaça não é regra geral:** a Tabela 5 exige CMAR para F-5/F-6 e L, e Controle de Fumaça para F-6 com lotação acima de 200 pessoas (nota 5); a 6F.3 exige CMAR para F-5/F-6, e Controle de Fumaça para F-6 e para F-5 acima de 60 m (nota 4); a 6L.1 exige Segurança Estrutural e CMAR para L-2 e L-3 (nota 3); a 6M.1 tem Segurança Estrutural e Controle de Fumaça; a 6C tem Compartimentação Vertical para shopping center acima de 23 m (nota 2). A ausência no campo 4 de existente regularizada **só não é pendência quando a tabela da divisão não traz a linha**. Conferido no PDF e nos `tab-rt05-*.json` em 24/09/2026; a versão anterior deste item generalizava a partir das 6I e 6J.
